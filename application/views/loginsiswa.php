...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo base_url() ?>assets/images/student.png">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <img src="<?php echo base_url() ?>assets/images/student.png" width="150px"alt=""><br><br>

                            <?php echo form_open ('loginsiswa'); 
                            ...
                            ?>
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Masukkan Nis Anda" name="username" type="text">
